...
### animation ###
parser.add_argument('--start_frame', type=int, default=10000, help='from which frame to start visualize')
parser.add_argument('--end_frame', type=int, default=10300, help='to which frame to end visualize')
...
coords_ori,dist_time,joints_dict = get_prepared(input_path,frame_range=[args.start_frame,args.end_frame])
...
# animation
ani1 = animation.FuncAnimation(fig,plot_func,frames=N_frames,fargs=(ax1,joints_dict,coords_ori,limits_1,title_1,
